...
const NamleOnline = ({ matchData, onAnswerSubmit, gameState, gameTimer }) => {
  ...
  const handleNameSubmit = () => {
    ...
    onAnswerSubmit({
      answer: nameGuess.trim(),
      timeTaken: 60 - gameTimer
    });
    
    setAttempts(prev => [...prev, nameGuess.trim()]);
    setNameGuess('');
  };
  ...
  const renderGameInterface = () => (
    <Box sx={{ textAlign: 'center', mb: 4 }}>
      ...
      <Button
        ...
        disabled={!nameGuess.trim() || gameEnded}
        sx={{ 
          bgcolor: '#43cea2',
