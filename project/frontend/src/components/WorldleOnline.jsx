...
const WorldleOnline = ({ matchData, onAnswerSubmit, gameState, gameTimer }) => {
  ...
  const handleWordSubmit = () => {
    ...
    onAnswerSubmit({
      answer: wordGuess.trim(),
      timeTaken: 60 - gameTimer
    });
    
    setAttempts(prev => [...prev, wordGuess.trim()]);
    setWordGuess('');
  };
  ...
  const renderGameInterface = () => (
    <Box sx={{ textAlign: 'center', mb: 4 }}>
      ...
      <Button
        ...
        disabled={!wordGuess.trim() || gameEnded}
        sx={{ 
          bgcolor: '#43cea2',
